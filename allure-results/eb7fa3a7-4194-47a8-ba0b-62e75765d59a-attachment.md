...
Call log:
  - waiting for locator('//strong[text()=\'View Cart\']')
...
```ts
  ...
  22 |         this.lnkViewCart = page.locator("//strong[text()='View Cart']");
  23 |     }
  24 | 
  25 |     /**
  ...
  65 |     }
  66 | 
  67 |     async clickviewcart():Promise<void>{
> 68 |         await this.lnkViewCart.click();
     |                                ^ Error: locator.click: Test timeout of 30000ms exceeded.
  69 |     }
  70 | 
  71 | 
